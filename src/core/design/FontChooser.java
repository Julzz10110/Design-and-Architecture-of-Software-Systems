...
public class FontChooser extends JComponent {
    ...
    public FontChooser(String[] fontSizeStrings) {
        ...
        selectPanel.setBackground(MainFrame.getInstance().getBackgroundColor());

        JPanel contentsPanel = new JPanel();
        contentsPanel.setLayout(new GridLayout(2, 1));
        contentsPanel.add(selectPanel, BorderLayout.NORTH);
        contentsPanel.add(getSamplePanel(), BorderLayout.CENTER);
        contentsPanel.setBackground(MainFrame.getInstance().getBackgroundColor());
    ...
    protected JDialog createDialog(Component parent) {
        ...
        JDialog dialog = new JDialog(frame, (MainFrame.getResourceBundle().getString("select_font")), true);
        ...
        cancelButton.setFont(MainFrame.getInstance().getTextFont());

        JPanel buttonsPanel = new JPanel();
        buttonsPanel.setLayout(new GridLayout(2, 1));
        buttonsPanel.add(okButton);
        buttonsPanel.add(cancelButton);
        buttonsPanel.setBackground(MainFrame.getInstance().getBackgroundColor());
        ...
        dialogEastPanel.setBackground(MainFrame.getInstance().getBackgroundColor());
    ...
    protected JPanel getFontFamilyPanel() {
        if (fontNamePanel == null) {
            ...
            p.setBackground(MainFrame.getInstance().getBackgroundColor());

            JLabel label = new JLabel((MainFrame.getResourceBundle().getString("font_name")));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
            label.setLabelFor(getFontFamilyTextField());
            label.setDisplayedMnemonic('F');
            label.setForeground(MainFrame.getInstance().getTextColor());
            label.setFont(MainFrame.getInstance().getTextFont());
    ...
    protected JPanel getFontStylePanel() {
        if (fontStylePanel == null) {
            ...
            JLabel label = new JLabel((MainFrame.getResourceBundle().getString("font_style")));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getFontSizePanel() {
        if (fontSizePanel == null) {
            ...
            JLabel label = new JLabel((MainFrame.getResourceBundle().getString("font_size")));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getSamplePanel() {
        if (samplePanel == null) {
            Border titledBorder = BorderFactory.createTitledBorder(
                    BorderFactory.createEtchedBorder(), (MainFrame.getResourceBundle().getString("sample")));
    ...
    private void updateDesign() {
        setBackground(MainFrame.getInstance().getBackgroundColor());
        fontNamePanel.setBackground(MainFrame.getInstance().getBackgroundColor());
        fontStylePanel.setBackground(MainFrame.getInstance().getBackgroundColor());
        fontSizePanel.setBackground(MainFrame.getInstance().getBackgroundColor());
        samplePanel.setBackground(MainFrame.getInstance().getBackgroundColor());
    }
    ...
    protected class DialogOKAction extends AbstractAction {
        protected String ACTION_NAME = MainFrame.getResourceBundle().getString("ok");
    ...
    protected class DialogCancelAction extends AbstractAction {
        protected String ACTION_NAME = MainFrame.getResourceBundle().getString("cancel");
        private JDialog dialog;
